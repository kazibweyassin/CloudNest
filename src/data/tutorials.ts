// Professional Tutorial Data for African Developers
// This file contains comprehensive tutorial content with African context

export const PROFESSIONAL_TUTORIALS = [
  {
    id: '1',
    slug: 'introduction-to-kubernetes',
    title: 'Introduction to Kubernetes',
    content: 'Master the fundamentals of Kubernetes and container orchestration with hands-on examples from African tech companies. Learn pods, deployments, and scaling strategies.',
    difficulty: 'BEGINNER',
    order: 1,
    lessons: [
      {
...
- African-specific considerations for pod deployment`,
  ...
  },
  {
    ...
    content: 'Learn to create and manage Kubernetes pods with real-world examples from African e-commerce platforms. Understand pod lifecycle, resource management, and debugging techniques.',
    difficulty: 'BEGINNER',
    order: 2,
    lessons: [
      {
...
- [ ] Monitor performance metrics`,
  ...
  },
  {
    ...
    content: 'Understand Kubernetes services and networking patterns used in African fintech applications. Learn load balancing, service discovery, and network policies.',
...
// Additional tutorials for comprehensive coverage
export const ADDITIONAL_TUTORIALS = [
  {
    id: '4',
    slug: 'mobile-money-api-deployment',
    title: 'Mobile Money API Deployment',
    content: 'Deploy a production-ready mobile money API using Kubernetes patterns from African fintech companies. Learn high availability, security, and compliance.',
    difficulty: 'ADVANCED',
    order: 4,
    lessons: [
      {
        id: '1',
        title: 'Mobile Money Architecture',
        description: 'Design scalable mobile money API architecture',
        content: `# Mobile Money API Architecture

Design a production-ready mobile money API architecture for African markets.
...
## African Context: Multi-Country Deployment
...
- **Auto Scaling**: Horizontal Pod Autoscaler`,
  ...
  },
  {
    ...
    content: 'Manage configuration and sensitive data in Kubernetes for African banking and fintech applications. Learn security best practices and compliance.',
    difficulty: 'INTERMEDIATE',
    order: 5,
    lessons: [
      {
        ...
        description: 'Learn to manage application configuration',
...
data:
  app.properties: |
    ...
    redis.port=6379
    payment.gateway.url=https://api.flutterwave.com/v3
    notification.sms.provider=twilio
    notification.email.provider=sendgrid
  nginx.conf: |
    server {
        listen 80;
        server_name api.mobilemoney.africa;
        location / {
            proxy_pass http://mobile-money-api:8080;
        }
    }
\`\`\`
...
data:
  ...
  api-key: Zmx1dHRlcndhdmUtYXBpLWtleQ==  # base64 encoded
  jwt-secret: and0LXNlY3JldC1rZXk=  # base64 encoded
\`\`\`

## African Context: Financial Compliance
...
- **Compliance**: Meet local financial regulations

## Best Practices

1. **Separate Concerns**: Use ConfigMaps for config, Secrets for sensitive data
...
5. **Monitoring**: Monitor configuration changes`,
  ...
  },
  {
    ...
    content: 'Build a scalable e-commerce platform optimized for African markets with low bandwidth considerations. Learn cost optimization and performance tuning.',
    difficulty: 'ADVANCED',
    order: 6,
    lessons: [
      {
        ...
        description: 'Design scalable e-commerce platform for Africa',
        content: `# E-commerce Platform Architecture

Design a scalable e-commerce platform optimized for African markets.
...
## African Context: Low-Bandwidth Optimization
    ...
    spec:
      ...
      - name: frontend
        ...
        - name: ENABLE_IMAGE_COMPRESSION
          value: "true"
        - name: CDN_URL
          value: "https://cdn.ecommerce.africa"
        resources:
          requests:
            memory: "256Mi"
            cpu: "200m"
...
export const ALL_TUTORIALS = [...PROFESSIONAL_TUTORIALS, ...ADDITIONAL_TUTORIALS];
